        ...
        <View style={ss.cardTop}>
          <View style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 8, marginTop: 3 }}>
              {c.old_price != null && <Text style={ss.oldPrice}>{Number(c.old_price).toFixed(2)}€ antes</Text>}
              <Text style={ss.newPrice}>→ {c.new_price != null ? Number(c.new_price).toFixed(2) : '—'}€</Text>
            </View>
